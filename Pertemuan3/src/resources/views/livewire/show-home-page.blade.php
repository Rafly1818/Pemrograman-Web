          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="block text-center text-lg-start pe-0 pe-xl-5">
              ...
              <p class="mb-4">{{ $pageconfig->detail }}</p> <a type="button"
                class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">cari lebih<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="ps-lg-5 text-center">
              <img loading="lazy" decoding="async"
                src="{{ $pageconfig->image ? Storage::url($pageconfig->image) : asset('front/images/banner.png') }}"
